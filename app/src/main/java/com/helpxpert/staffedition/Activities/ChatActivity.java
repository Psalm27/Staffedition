...
import com.helpxpert.staffedition.adapters.ChatAdapter;
import com.helpxpert.staffedition.databinding.ActivityChatBinding;
import com.helpxpert.staffedition.models.ChatMessage;
import com.helpxpert.staffedition.models.User;
import com.helpxpert.staffedition.network.ApiClient;
import com.helpxpert.staffedition.network.ApiService;
...
public class ChatActivity extends BaseActivity {
    ...
    private void listenAvailabilityofReceiver(){
        database.collection(Constants.KEY_FACILITY_USERS).document(receiverUser.id).addSnapshotListener(ChatActivity.this, (value, error) -> {
            if(error != null){
                return;
            }
            if(value != null){
